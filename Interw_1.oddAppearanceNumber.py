...
printTwoOdd_1([1,2,3,1,1,1,1,5,5,5,8])


# Method 2 : XOR
# reference 1: https://www.geeksforgeeks.org/find-the-two-numbers-with-odd-occurences-in-an-unsorted-array/
# reference 1: https://www.runoob.com/python/python-operators.html#ysf5
# Time Complexity: O(n)
